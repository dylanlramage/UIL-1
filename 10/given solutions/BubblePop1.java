...
public class BubblePop1
{
	...
	public static void main(String[] args) throws IOException
	{
		...
		Scanner input = new Scanner(new File("bubblepop1.dat"));
		PrintWriter output = new PrintWriter(new File("bubblepop1.out"));	
		...
		{		
			...
			{
				out.println("YES "+count);
				output.println("YES "+count);
			}							
		}
